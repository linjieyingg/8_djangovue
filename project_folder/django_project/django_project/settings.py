...
with open(os.path.join(
        BASE_DIR, 'django_project', 'secrets.json')) as f:
...
SECRET_KEY = 'django-insecure-yo596bp8e&q6d1xnb7t5%5)8^hpgf)ij__!!x@x%&b=u!!rwvw'
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "django_project_static")
...
LOGIN_REDIRECT_URL = "/reminders/reminders/"
LOGOUT_REDIRECT_URL = "/"
